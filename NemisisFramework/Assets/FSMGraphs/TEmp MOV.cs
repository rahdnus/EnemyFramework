...
//        controller.agent.enabled=false;
    ...
    {
                controller.transform.position+=(controller.transform.right*horizontal+controller.transform.forward*vertical)*movementSpeed*run_multiplier;
